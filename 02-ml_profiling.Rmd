...
* Model-specific parameter point estimates obtained by nls regression analysis (\@ref(nls)) tested for parameter identifiability based on maximum likelihood profiling 
